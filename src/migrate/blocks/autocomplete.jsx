...
registerBlockType('dev/autocomplete', {
    ...
    edit: class extends Component {
        ...
        constructor() {
            ...
            // accessible-autocomplete accepts an array of strings, remove the first element
            this.state.array_of_countries = this.state.countries.map( option => option.value ).slice( 1 );
            this.accessibleAutocompleteContainer = React.createRef();
        }
        ...
        initializeAccessibleAutocomplete() {
            accessibleAutocomplete( {
                ...
                source: this.state.array_of_countries,
                defaultValue: this.props.attributes.country_accessible_autocomplete,
                minLength: 2,
                displayMenu: 'inline',
                onConfirm: name => {
                    if( name ) {
                        return this.props.setAttributes( { country_accessible_autocomplete: name } );
                    }
                }
            } );
        }
        ...
        componentDidMount() {
            ...
            if( this.accessibleAutocompleteContainer.current ) {
        ...
        render() {
            ...
            return <div>
                ...
                <div ref={ this.accessibleAutocompleteContainer }>
                    <h5>alphagov/accessible-autocomplete</h5>
                ...
                <div>
                    ...
                    <Select
                        ...
                        value={
                            this.state.countries.filter( option =>
                                option.value === this.props.attributes.country_react_select
                            )
                        }
                        isClearable={ true }
                        //clearValue={ () => ( { value: null, label: 'Start typing ...' } ) }
                        onChange={
                            option => this.props.setAttributes( {
                                country_react_select: option != null ? option.value : null
                            } )
                        }
                    />
                </div>
